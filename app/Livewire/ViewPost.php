...
class ViewPost extends Component
{
    ...
    public function render()
    {
        $post = Post::with(['comments' => function($q) {
            $q->latest();
        }, 'comments.user'])->findOrFail($this->postId);
    ...
    public function placeholder()
    {
        ...
        <div>
            <div role="status"
            class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center mb-8 opacity-25">
